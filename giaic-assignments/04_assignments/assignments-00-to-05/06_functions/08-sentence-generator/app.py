...
# "Looking out my window, the sky is big and ____!" make_sentence(word, part_of_speech) should not return anything,
...
def make_sentence(word: str, part_of_speech:int):
    ...
    if part_of_speech == 0:
        ...
        print("Part of speech must be 0, 1, or 2❗")            

def main():
    word: str = input("Please type Noun, Verb, or Adjective: ")
